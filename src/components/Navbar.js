...
const Navbar = () => {
    ...
    return (
      <nav class={`flex items-center justify-between z-50 flex-wrap bg-white pr-4 pl-4 pt-1 pb-1 lg:pl-20 lg:pr-20 ${showMenu ? "text-left": "text-center"} border-b border-gray-200 shadow-sm`}>
